...
test(extract(STEP[0], ({p}) => p), 'p')
test(extract(STEP[3], ({n}) => n), null)
test(extract(STEP[3], ({n: {p}}) => p), undefined)
test(extract(STEP[0], ({v}) => v), 'v')
test(extract(STEP[1], ({p: {v}}) => v), 'v')

console.group('undefined - leaf')
test(extract(STEP[0], ({p1}) => p1), undefined)
test(extract(STEP[1], ({p: {p1}}) => p1), undefined)
console.groupEnd()

console.group('undefined - middle')
test(extract(STEP[1], ({p1: {p}}) => p), undefined)
test(extract(STEP[2], ({p:{p1}}) => p1.p), undefined)
test(extract(STEP[2], ({p1: {p}}) => p.p), undefined)
console.groupEnd()
console.groupEnd()
